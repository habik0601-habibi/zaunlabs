...
export default {
  // Gates every `hover:` variant behind `@media (hover: hover)`. On a phone a
  // tap otherwise latches the hover state (lifted cards, colour swaps) until
  // you tap elsewhere. No effect on pointer devices.
  future: {
